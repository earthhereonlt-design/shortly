  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-3xl p-6 shadow-soft outline-none",
        className,
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-5 top-5 rounded-lg p-1 text-ink-muted transition-colors hover:bg-surface-elevated hover:text-ink">
        <X className="h-4 w-4" />
